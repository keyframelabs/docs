<Steps>
  <Step title="Create the HTML" stepNumber={1}>
    ...
    <html lang="en">
      ...
      <script type="module">
        import { PersonaView } from 'https://esm.sh/@keyframelabs/elements@latest';
...
- The Keyframe Elements SDK uses these ephemeral credentials to establish all necessary real-time audio/video connections to display and interact with your avatar